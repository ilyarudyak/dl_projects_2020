...
### - training on the full dataset is to slow even with GPU
###   and the dataset is too biased for detection of pneumonia
###   so we just down sampled non pneumonia examples;
### - first we down sampled it 1:1 and then 1:5 and used weighted
###   loss function;
#################################################################
